...
The type scale ships as 16 `typography-*` utility classes rather than tokens. [Tailwind setup](/ui/tailwind-setup#typography-utilities) lists all 16 with their sizes and weights.

The icon sets have their own reference pages: [Icons](/ui/components/icons) for the 172 static icons, [Animated icons](/ui/components/animated-icons) for the 69 animated twins, and [CountryFlag](/ui/components/country-flag) for the flag artwork.
