...
Three lines in your app's CSS entry point, in this order:
...
Declare the layer order at the top of your entry point so your own overrides land where you expect and Tailwind utilities beat component classes:
...
There are 16 of them across five families: `typography-header-*`, `typography-body-*`, `typography-description-*`, `typography-badge-*`, and `typography-links-*`. Storybook's **Foundations** section lists every one with its rendered size.
