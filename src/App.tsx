...
function IconsDemo() {
  const allIcons = [
    ...
    ["Danger", DangerIcon],
    ["Diamond", DiamondIcon],
    ["DiscountCircle", DiscountCircleIcon],
    ["Donate", DonateIcon],
    ...
    ["Logout", LogoutIcon],
    ["LoveClick", LoveClickIcon],
    ["Medal", MedalIcon],
    ["Menu", MenuIcon],
    ["MessageFavorite", MessageFavoriteIcon],
    ...
    ["Upload", UploadIcon],
    ["UserCircleAdd", UserCircleAddIcon],
    ...
    <div id="icons" className="flex scroll-mt-20 flex-col gap-4">
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-end gap-6 rounded-lg bg-background-white-solid-constant p-4 text-body-black-solid-constant">
          ...
          <div className="flex flex-col items-center gap-2">
            <VipBadgeIcon className="size-6" />
            <span className="text-[10px] leading-tight">VipBadge</span>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-end gap-6 rounded-lg bg-body-black-solid-constant p-4 text-body-white-solid-constant">
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="rounded bg-background-white-solid-constant p-1">
              <VipBadgeIcon className="size-6" />
            </div>
            <span className="text-[10px] leading-tight">VipBadge</span>
          </div>
