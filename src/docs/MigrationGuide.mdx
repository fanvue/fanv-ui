...
| `variant="heading3"` | `typography-bold-heading-sm` | 24px / 700 |
...
// @fanvue/ui + Tailwind
<h3 className="typography-bold-heading-sm">Title</h3>
...
> - These are `@utility` rules, so Tailwind modifiers work: `md:typography-bold-heading-sm`, `dark:typography-regular-body-lg`.
