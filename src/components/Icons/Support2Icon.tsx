...
export const Support2Icon = React.forwardRef<SVGSVGElement, IconProps>(
  ({ className, ...props }, ref) => {
    return (
      <svg
        ref={ref}
...
Support2Icon.displayName = "Support2Icon";
