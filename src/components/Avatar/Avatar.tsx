...
> = {
  ...
  24: { top: 0, right: 0, indicatorSize: "size-[10px]", borderSize: "border" },
  32: { top: 0, right: 0, indicatorSize: "size-3", borderSize: "border" },
  40: { top: 0, right: 0, indicatorSize: "size-[14px]", borderSize: "border" },
  48: { top: 0, right: 0, indicatorSize: "size-4", borderSize: "border" },
  64: { top: 2, right: 0, indicatorSize: "size-[18px]", borderSize: "border" },
