...
export const WithBackAndActions: Story = {
  render: (args) => (
    <MainContainerHeader {...args} className="max-w-xl">
      <MainContainerHeaderStart>
        <IconButton variant="tertiary" size="32" icon={<ArrowLeftIcon />} aria-label="Back" />
        <Avatar src={demoAvatar} alt="Creator" fallback="C" size={40} onlineIndicator />
        <MainContainerHeaderTitle>Title</MainContainerHeaderTitle>
      </MainContainerHeaderStart>
      <MainContainerHeaderEnd>
        ...
        <span className="typography-regular-body-sm whitespace-nowrap text-foreground-secondary">
          GMT +01
        </span>
      </MainContainerHeaderEnd>
    </MainContainerHeader>
