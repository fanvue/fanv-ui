        ...
        >
          ...
          <SelectPrimitive.Root disabled={disabled} {...props}>
            <SelectPrimitive.Trigger
              ...
              className={cn(
                "flex w-full cursor-pointer items-center justify-between rounded-sm border bg-neutral-alphas-50 focus-visible:shadow-focus-ring focus-visible:outline-none motion-safe:transition-colors",
                TRIGGER_HEIGHT[size],
