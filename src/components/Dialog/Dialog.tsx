...
/**
 * Props for {@link DialogItem}, the v2 modal action row.
 *
...
/**
 * A single action row inside a {@link Dialog}. Matches the v2 modal item:
 * 40px min height, 12px horizontal padding, 16px label, optional leading icon.
 *
 * @example
 * ```tsx
 * <DialogItem leadingIcon={<EditIcon size={16} />} onClick={onEdit}>
 *   Edit List
 * </DialogItem>
