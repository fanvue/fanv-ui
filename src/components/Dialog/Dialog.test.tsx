    ...
    render(
      <Dialog defaultOpen>
        <DialogContent>
          ...
          <DialogBody>
            <DialogItem leadingIcon={<span data-testid="icon" />}>Edit List</DialogItem>
          </DialogBody>
        </DialogContent>
      </Dialog>,
    );
    ...
    render(
      <Dialog defaultOpen>
        <DialogContent>
          ...
          <DialogBody>
            <DialogItem selected>Add to Favourites</DialogItem>
          </DialogBody>
        </DialogContent>
      </Dialog>,
    );
    ...
    render(
      <Dialog defaultOpen>
        <DialogContent>
          ...
          <DialogBody>
            <DialogItem onClick={onClick}>Duplicate</DialogItem>
          </DialogBody>
        </DialogContent>
      </Dialog>,
    );
    ...
    render(
      <Dialog defaultOpen>
        <DialogContent>
          ...
          <DialogBody>
            <DialogItem closeOnSelect={false}>Add to Favourites</DialogItem>
          </DialogBody>
        </DialogContent>
      </Dialog>,
    );
