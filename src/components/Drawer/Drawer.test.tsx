...
describe("Drawer", () => {
  ...
  describe("open/close", () => {
    ...
    it("closes on overlay click", async () => {
      ...
      await user.click(screen.getByRole("button", { name: "Open drawer" }));
      expect(screen.getByRole("dialog")).toBeInTheDocument();
      const overlay = document.querySelector(".bg-surface-backdrop");
  ...
  describe("overlay", () => {
    it("renders overlay by default", async () => {
      ...
      renderDrawer();
      await user.click(screen.getByRole("button", { name: "Open drawer" }));
      expect(document.querySelector(".bg-surface-backdrop")).toBeInTheDocument();
    });
    ...
    it("does not render overlay when overlay=false on root", async () => {
      ...
      await user.click(screen.getByRole("button", { name: "Open drawer" }));
      expect(document.querySelector(".bg-surface-backdrop")).not.toBeInTheDocument();
    });
