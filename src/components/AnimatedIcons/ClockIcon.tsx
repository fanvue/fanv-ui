...
/*! Animated icon artwork from lucide-animated (MIT, (c) 2024-2026 pqoqubbw) — https://lucide-animated.com (registry item "clock"). @license MIT */
...
/** Props for {@link ClockIcon}. See {@link AnimatedIconProps} for the shared shape. */
export type ClockIconProps = AnimatedIconProps;

/** Imperative handle for {@link ClockIcon}, via its `controlRef` prop. */
export type ClockIconHandle = AnimatedIconHandle;

/**
 * Animated Clock icon — the animated twin of `ClockIcon` from
 ...
 * @example
 * ```tsx
 * import { ClockIcon } from "@fanvue/ui/animated-icons";
 *
 * <ClockIcon size={24} />
 * ```
 */
